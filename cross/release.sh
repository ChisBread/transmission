...
#cd $TR_ROOT
#sudo docker buildx build --push --platform=linux/amd64,linux/arm/v7,linux/arm64/v8 --tag chisbread/transmission:staging-v0.1 --tag chisbread/transmission:staging -f cross/Dockerfile.buildx .
